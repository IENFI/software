...
public class MailService {
    ...
    private static final String senderEmail= "forest1205.rabbit@gmail.com";
    ...
    public MimeMessage CreateMail(String mail) throws MessagingException, UnsupportedEncodingException {
        ...
        msg += "<p style=\"font-size: 17px; padding-right: 30px; padding-left: 30px;\">아래 확인 인증 번호를 dms 화면 내에 입력해주세요.</p>";
